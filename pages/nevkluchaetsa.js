          ...
          <div className="page-left-main-box">
            ...
            <section className="page-container11">
              ...
              <strong className="page-text14">
                <span>Стиральная машина не включается:</span>
                <br></br>
              </strong>
            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  <span className="page-text19">1. Отключите машинку от сети и безопасности.</span>
                  <span> Прежде чем разбирать что-либо, обяза��ельно вытащите вилку из розетки и перекройте водоподачу. Это защитит вас от удара током и подтопления.</span>
                  <br className="page-text21"></br>
                  <span className="page-text22">2. Проверьте электрическую цепь.</span>
                  <span> Убедитесь, что автомат в электрощите включён, а провод питания и розетка не повреждены. Подключите к той же розетке другой прибор, чтобы убедиться, что питание есть.</span>
                  <br className="page-text24"></br>
                  <span className="page-text25">3. Осмотрите дверцу.</span>
                  <span> Откройте люк и закройте его заново до характерного щелчка. Иногда простое неплотное закрытие блокирует пуск. Проверьте, не мешают ли защёлке посторонние предметы или грязь.</span>
                  <br className="page-text27"></br>
                  <span className="page-text28">4. Проверьте подачу воды.</span>
                  <span> Откройте кран подачи воды для стиральной машины и осмотрите заливной шланг: нет ли перегиба или засора на входе. Сломанный или перекрученный шланг и закрытый кран тоже остановят работу.</span>
                  <br className="page-text30"></br>
                  <span className="page-text31">5. Перезапустите об��рудование.</span>
                  <span> Отключите машин�� от сети на несколько минут (примерно на 10–15), затем включите снова. Иногда однократный «глюк» электроники устраняется сбросом питания.</span>
                  <br className="page-text27"></br>
                  <span className="page-text28">6. Проверьте фильтры и шланги.</span>
                  <span> Если машинка всё ещё не подаёт признаков жизни, осмотрите сетевой фильтр и впускной клапан. Для фильтра нужен мультиметр, для клапана — визуальный о��мотр или звон мастеру. Часто эти детали меняют полностью.</span>
                  <br></br>
                </p>
              </div>
            </section>
            ...
            <section id="5-1" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Практически все стиралки блокируют дверцу перед стартом (из соображений безопасности). Если замок (Устройство Блокировки Люка, УБЛ) сломан или просто ��е фиксирует дверцу, машина не даст себя включить. Проявляется это тем, что при попытке старта ничего не происходит — машинка не отвечает на нажатия. На некоторых моделях на экране появляется код ошибки, связанный с дверцей: например, LG выдаёт «dE», Samsung — «DC». Часто бывает и просто «виснет»: люк не захлопнут до конца. Попробуйте открыть и затем сильно закрыть дверцу до щелчка – иногда достаточно убедиться, что она плотно заперта. Если же замок действительно сломан, ��го придётся заменить. Устройство состоит из микровыключателя и заслонки — ремонт нецелесообразен, заменять нужно весь узел. До замены машина работать не будет (ее «кидает»: ни вода не набирается, ни барабан не крутится).
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section className="page-frame1299">
              ...
              <div className="page-frame12982">
                <span className="page-text74">
                  Как продлить жизнь машине на 3–5 лет — простые привычк��,

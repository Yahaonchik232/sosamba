          ...
          <article className="frame1196-cards">
            ...
            <Link href="/negreetvodu">
              <a className="frame1196-container114">
                ...
                <img
                  alt="Стираль��ая машина не нагревает воду"
            ...
            <Link href="/protekaet">
              <a className="frame1196-container115">
                <h3 className="frame1196-text114">Стир��льная машина протекает</h3>
            ...
            <Link href="/neotkrivaetsadverca">
              <a className="frame1196-container121">
                ...
                <img
                  alt="Не открывается дверца стиральной маш��ны"
              ...
              text={
                <Fragment>
                  <span className="frame1196-text171">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: 'Зам��на сливного насоса (с учетом сто��мости н��соса)',
                      }}
                    ></span>
                  </span>
                </Fragment>
        ...
        to {
          ...
          <div className="frame1196-container151 carousel">
            <div className="frame1196-container152 track">
              ...
              <div className="item">
                <img
                  alt="Ремонт стиральных машин Miele в Одессе - пр��фессион��льный ��ер��ис"
              ...
              <div className="item">
                <img
                  alt="Рем��нт стиральных ���ашин Samsung в О��ессе - профессиональный сервис"
...
to {transform: translateX(-2620px);}}
                ...
                <div className="frame1196-container173">
                  <div className="frame1196-container174">
                    <h3 className="frame1196-text222">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: 'Низкие цены на весь сервисный диапазо�� услуг',
                        }}
                      ></span>
                    </h3>
                    <svg
            ...
            <div className="frame1196-container179">
              ...
              <div className="frame1196-container180">
                ...
                <p className="frame1196-text227">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'Подтвержда��м надёжность ремонта длительным сроком гарантии.',
                    }}
                  ></span>
                </p>
              </div>
          ...
          <div className="frame1196-container215">
            ...
            <div className={`frame1196-otvet3 ${activeFAQ === 3 ? 'faq-active' : ''}`}>
                <p className="frame1196-text244">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'Диагно��ти��а стоит 200 гривен. При согласии на ремонт ст��имость диа��ностики засчитывается в общую сумму работ. Выезд мастера бесплатный',
                    }}
                  ></span>
                </p>
            </div>
        ...
        <div className="frame1196-container225">
          ...
          <p className="frame1196-text251 textITOGI">
            <span
              dangerouslySetInnerHTML={{
                __html: 'Стиральн��я машин�� — эт�� техника, которая должна работать исправно: отжимать, сти��ать и радовать стабил��нос��ью.',
              }}
            ></span>
          </p>
          <p className="frame1196-text252 textITOGI">
            <span
              dangerouslySetInnerHTML={{
                __html: 'П��д брендом "Ваше ��азвание" работает команда масте��ов...',
              }}
            ></span>
          </p>
          ...
          <ul className="frame1196-ul1 list">
            ...
            <li className="list-item">
              <span className="textITOGI">
                <span
                  dangerouslySetInnerHTML={{
                    __html: 'Работаем как �� типов��ми, та�� и со сложными неисправностями.',
                  }}
                ></span>
              </span>
            </li>
          ...
          <h2 className="textglavitogi">
            <span
              dangerouslySetInnerHTML={{
                __html: 'Частые поломки с��ирал��ных машин',
              }}
            ></span>
          </h2>

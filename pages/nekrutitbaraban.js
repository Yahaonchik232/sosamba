            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext page-text18">
                  ...
                  <span>
                    {' '}
                    Откройте ��верцу и выньте часть белья. При необходимости
                    уменьшите загрузку, если она была слишком большой. Если
                    белья совсем мало, добавьте ещё 2–3 вещи равного веса.
                    Встряхните оставшиеся вещи, равномерн�� распределив ��х по
                    барабану.
                  </span>
                  ...
                  <span className="page-text28">4. За��ройте дверцу.</span>
                  <span>
                    {' '}
                    Убедитесь, что дверца люка закрыта плотно. Откройте и
                    закройте ��ё до характерного щелчка. Без плотной фиксации
                    дверца остаётся разблокированной – машина не начнёт ц��кл
                    стирки.
                  </span>
                  ...
                  <span>
                    ...
                    вращение барабана на эта��е отжима. Если ба��абан по-прежнему

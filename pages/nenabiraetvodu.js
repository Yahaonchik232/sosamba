            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  <span className="page-text19">1. Выключите питание и закройте кран.</span>
                  <span> Прежде чем проверять узлы машины, отключите её от электросети и перекройте подачу воды. Так вы обезопасите себя и технику.</span>
                  <br className="page-text21"></br>
                  <span className="page-text22">2. Проверьте кран и напор.</span>
                  <span> Откройте кран на полную мощность и оцените напор. Если воды нет в кране, позвоните в коммунальную службу. Если вентиль был закрыт, полностью его откройте.</span>
                  <br className="page-text24"></br>
                  <span className="page-text25">3. Осмотрите заливной шланг.</span>
                  <span> Убедитесь, что на шланг ничего не давит и нет перегибов. Открутите его от машины (не забудьте поставить под него таз) и проверьте, идёт ли из него вода. Если шланг пережат или перекручен, распрямите его или замените.</span>
                  ...
                  <span> Иногда помогает простой сброс: отключите СМА от сети на 10–15 секунд, затем включите заново. Это снимает случайные ошибки блока управления.</span>
                  <br></br>
                </p>
              </div>
            </section>

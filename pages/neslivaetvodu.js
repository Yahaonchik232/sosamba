          ...
          <div className="page-left-main-box">
              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  ...
                  <span>
                    ...
                    Встр  хните оставшиеся вещи, равномерн   распределив их по
                    барабану.
                  </span>
                  ...
                  <span>
                    {' '}
                    Убедитесь, что дверца лю  а закрыта плотно. Откройте и
            ...
            <section id="3" className="page-thirdproblem2">
              <div className="page-container19 zagolovkiskorobkoy">
                <h3 className="zagolovki2">2. Неисправность сливного насоса</h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
                  height="20"

          ...
          <div className="page-left-main-box">
            <div className="page-headertextwashermachine">
              ...
              <h1 className="page-text10">
                <span className="page-text11">
                  Стиральная машина не кр  тит барабан —
                </span>
            ...
            <section className="page-container11">
              ...
              <strong className="page-text14">
                <span>Стиральна�� машина не крутит барабан:</span>
                <br></br>
              </strong>
            ...
            <section id="2" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  1. Неисправность датчика уровня воды (прессостата)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  ...
                  ��ашина может ошибочно считать бак пустым и не подавать команду
            ...
            <section id="2a" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Сливной фильтр улавливает мелкие предметы и ворсинки, не давая им попасть в насос. Как правило, он находится в нижней части корпуса за откидной крышкой. Перед началом любых работ обязательно отключите машину от сети и подготовьте ёмкость для слива. Аккуратно открутите крышку фильтра против часовой стрелки – под ней немедленно начнёт вытекать вода.( см. ��ак правильно сливать воду ) Как только в баке останется мало воды, сработает защёлка запорного механизма, и дверца разблокируется. После этого полностью вытащите фильтр и очистите его от скопившейся пыли, волос, монеток и других посторонних предметов. Собирая обратно, будьте осторожны: пластмассовый фильтр хрупкий. Если засор в фильтре был причиной проблемы, после его очистки вода будет свободно уходить, а люк должен открыться.
                </p>
              </div>
            </section>
            <section id="2b" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Современные машины контролируют уровень воды с помощью прессостата – герметичной ёмкости с трубкой и датчиком давления. Если прессостат сломан или его шланг оторвался, машина может ошибочно считать ��ак пустым и не подавать команду на слив. Обычно в этом случае м��шина останавливается с кодами ошибок RE или OE. Проблему иногда решают проверкой и прочисткой трубки прессостата, в более сложных случаях – заменой датчика.
                </p>
              </div>
            </section>
            ...
            <section id="2e" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Гибкий сливной шланг идёт от насоса к стояку канализации. Важно у��ед��ться, что он не пережат и не забит грязью или жиром, особенно в местах изги��ов и подсоединения к раковине или сифону. Для проверки отсоедините шланг от канализации и попробуйте продуть его: при чистом шланге воздух проходит легко и слышно, как булькает оставшаяся вода. Если шланг забит, протолкните внутрь гибкую проволоку или промойте его под струёй горячей воды. После прочистки установите шланг на место и убедитесь, что он нигде не перегибается и надёжно закреплён.
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  1. Если ваша стиральная машина подключена к сети, начните с отключения питания — просто выньте вилку из ро��етки. Это обязательная мера безопасности, которая исключает риск удара током при любых действиях с техникой.2. Затем подготовьте всё необход��мое для слива воды. Возьмите несколько тряпок или старых полотенец — они помогут впитать пролитую воду и уберечь пол. Также стоит заранее приготовить невысокую ёмкость: например, плоский таз, миску или лоток. Если машинка установлена в ванной и есть возможность подвести шланг в душевую или ванну — это упростит задачу. В остальных случаях воду придётся собирать и переносить вручную — понадобится отдельн��е ведро или таз для слива.3. Если стирка завершилась недавно, не торопитесь — дождитесь, пока вода остынет. Температуру можно примерно оценить, приложив руку к стеклу люка: е��ли оно го��ячее, лучше немного подождать.4. Далее найдите сливной фильтр — он обычно расположен внизу передней части корпуса. Закрыт он может быть небольшой пластиковой крышкой. В большинстве моделей она снимается вручную, но если крепится на винтах — понадобится подходящая отвёртка. Учтите, что фильтр находится низко, почти у самого пола, поэтому сливать воду нужно будет в плоскую посуду.5. Чтобы немного облегчить слив, можно аккуратно отодвинуть машинку от стены и чуть-чуть наклонить её назад — так остатки воды быстрее стекают к фильтру. Поднимать техн��ку лучше вдвоём, так как даже пустая машинка весит более 30 килограммов, а с водой и мокрым бельём — значительно больше.6. После того как вода полностью уйдёт, можно выкрути��ь фильтр до конца и проверить его на наличие засора — нередко там скапливаются волос��, нитки, мелкие предметы. Очистите фильтр, промойте его по�� краном и установите обратно.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                <figure className="page-container24">
                  ...
                  />
                  <span className="page-text45">Щетк   двигате��я</span>
                </figure>
                <p className="page-text46 vicetext">
                  {' '}
                  1. Регулярно очищайте фильтр. Чистый фильтр предотвращает заторы из ворса и мелкого мусора.2. Не допускайте попадания мелких предметов. Проверяйте карманы одежды перед стиркой: монеты, заколки, носовые платки и т.п. часто попадают в барабан и могут попасть в патрубок.3. Следите за положением сливного шланга. Шланг не должен сильно перегибаться или пережиматься. Оптимальная высота его вывода – до 50 см от уровня пола. При эксплуатации следите, чтобы машинка стояла ровно и вибрировала минимально: излишняя вибрация мож��т пе��етёреть провода или ослабить патрубки.4. Не за��ывайте проверять ка��ализацию. Убедитесь, что в стояке или сифоне нет засора. Если вода из раковины уходит медленно, жидкость из стиральной может застаиваться. Время от времени очищайте сантехнику в доме, чтобы слив машины работал беспрепятственно.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  ...
                  воды.Чтобы провер��ть патрубок, отключите машину, уложите её на

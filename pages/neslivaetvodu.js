          ...
          <div className="page-left-main-box">
            ...
            <section className="page-container11">
              ...
              <strong className="page-text14">
                <span>Основные причины отсутствия слива:</span>
                <br></br>
              </strong>
            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  Сливной фильтр улавливает мелкие предметы и ворсинки, не д��вая им попасть в насос. Как правило, он находится в нижней части корпуса за откидной крышкой. Перед началом любых работ обязательно отключите машину от сети и подготовьте ёмкость для слива. Аккуратно открутите крышку фильтра против часовой стрелки – под ней немедленно начнёт вытекать вода.( см. как правильно сливать в��ду ) Как только в баке останется мало воды, сработает защёлка запорного механизма, и дверца разблокируется. После ��то��о полностью вытащите фильтр и очистите его от скопившейся пыли, волос, монеток и других посторонних предметов. Собирая обратно, буд��те осторожны: пластмассовый фильтр хрупкий. Если засор в фильтре был причиной проблемы, после его очистки вода будет свободно уходить, а люк должен откр��ться.
                </p>
              </div>
            </section>
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  ...
                  давления. Если прессостат сломан или его шл��нг оторвался,
            ...
            <section id="2d" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Слив��ой патрубок (гофра) соединяет бак с насосом. Даже после чистки фильтра вода может не уходить, если в этом патрубке что-то застряло. Чаще всего вну��рь попадают монеты, пуговицы, обрывки ткани – они могут пе��иодически перекрывать проток воды.Чтобы проверить патрубок, отключите машину, уложите её на бок и снимите заднюю или нижнюю панель. Далее отсоедините патрубок от насоса: внутри часто обнаруживаются мелкие тряпочки, носки и мелкие детали. Удалите из патрубка мусор. После сборки ��роверьте слив – при отсутствии за��ора вода должна свободно уходить.
                </p>
              </div>
            </section>
            <section id="2e" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Гибкий сливной шланг идёт от насоса к стояку канализации. Важно у��ед��тьс��, что он не пережат и не забит грязью или жи��ом, особенно в местах изги��ов и под��оединения к раковине или сифону. Для проверки отсоедините шланг от канализации и попробуйте п��одут�� его: при чистом шланге воздух проходит легко и слышно, как булькает оставшаяся вода. Если шланг забит, протолкните внутрь гибкую проволоку или промойте его под струёй горячей воды. После прочистки установите шланг на место и убедитесь, что он нигде не перегибается и надёжно закреплён.
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  1. Если ваша ��тиральная машина подключ��на к сети, начните с отключения питания — просто выньте вилку из ро����етки. Это обязательн��я мера безопасности, которая ис��люч��ет риск удара т��ком при любых действиях с техникой.2. Затем подготовьте всё необход��мое для слива воды. Возьмите несколько тряпок или старых полотенец — они помогут впитать пролитую воду и уберечь пол. Также стоит заранее приготовить невысокую ёмкость: например, плоский таз, миску или лоток. Если машинка установлена в ванной и есть возможность подвести шланг в душевую или ванну — это упрос��ит задачу. В остальных случаях воду придётся собирать и переносить вручную — понадобится отдел��н��е ведро или таз для слива.3. Если стирка завершилась недавно, не торопитесь — дождитесь, пока вода остынет. Температуру можно примерно оценить, приложив руку к стеклу люка: е��ли оно го��яче��, лучше ��емного подож��ать.4. Далее найдите сливной фи��ьтр — он обычно расположен ��низу передней части корпуса. Закрыт он может быть небольшой пла��тиковой крышкой. В боль��инстве моделей она снимается вручную, но если крепится на винтах — понадобится подх��дящая отвёртка. Учти��е, ��то фильтр находится низко, почти у самого пола, поэтому сливать воду нужно будет в плоскую посуду.5. Чтобы немного облегчить слив, можно аккуратно отодвинуть машинку от стены и чуть-чуть наклонить её назад — так остатки воды быстрее стекают к фильтру. Поднимать техн��ку лучше вдвоём, так как даже пустая машинка весит более 30 килограммов, а с водой и мокрым бельём — значительно больше.6. После того как вода полностью уйдёт, можно выкрути��ь фильтр до конца и пр��верить его на наличие засора — нередко ��ам скапливают��я волос��, нитки, мелкие предметы. Очистите фильтр, промойте его по�� краном и установите обратно.
                </p>
              </div>
            </section>
            ...
            <section className="page-frame1299">
              ...
              <div className="page-frame12985">
                <span className="page-text77">
                  Как безопасно перевози��ь и хранить стиральную машину
                </span>

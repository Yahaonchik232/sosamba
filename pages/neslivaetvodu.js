              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  ...
                  <span className="page-text22">
                    2. Перерасп��еделите или уберите часть бел��я.
                  </span>
                  <span>
                    {' '}
                  ...
                  <span>
                    ...
                    мощности б��з загрузки белья. Просл��дите, начнётся ли
                    вращение барабана на эта��е отжима. Если барабан по-прежнему
                    не вращает��я, это укажет на неисправность механизма.
                  </span>
                  <br></br>
                </p>
              </div>
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  ...
                  полный отказ. При подозрении на износ щёток или внутренни��
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  ...
                  отжим; проявления варьируются о�� мигающих ошибок на дисплее до

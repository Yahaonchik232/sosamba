          ...
          <div className="page-left-main-box">
            <div className="page-headertextwashermachine">
              ...
              <h1 className="page-text10">
                <span className="page-text11">
                  Стиральная машина не к��утит барабан —
                </span>
            ...
            <section className="page-container11">
              ...
              <ul className="page-ul list">
                ...
                <li className="page-li2-new list-item">
                  <img alt="image" src="/vector.svg" className="page-image2" />
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  При первой установке новой стиральной машины многие удивляются сильной вибрации и шуму во ��ремя работы. Чаще всего это связано с тем, что ��стаются установочные транспортировочные болты, фиксирующие барабан для безопасной перевозки. Если их не снять до запуска, барабан не сможет свободно вращаться, что вызывает громкий грохот, подпрыгивание машины и риск повреждения деталей. Чтобы техника работала корректно и служила долго, обязательно выкрутите все транспортировочные болты и установите защитные заглушки.
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  Стиральная машина очень требова��ельна к прочн��сти и горизонтальности места установки. Если пол под ней не идеально ровный или слишком мягкий (нап��имер, с��арые деревянные доски), любая вибрация пр��ведёт к дополнительному «прыжку» техники. Аналогично, установка на оче��ь гладком покрытии (плитке или линолеуме) без фиксации позволит машинке подскальзывать.Совет: Проверьте положение машины уровнем – все ножки должны стоять устойчиво. Слегка раскачайте прибор руками, определите, какая опора «гуляет» больше, и подкрутите её гайкой против часовой стрелки до упора. Можно привлечь помощника или приподнять стиралку на бок, чтобы повернуть ножку удобнее. После этого ещё раз проконтролируйте ровность с уровнем. Для дополнительной устойчивости и защиты пола рекомендует��я установить резиновые антискользящие накладки или антивибрационные подставки под ножки. Они гасить час��ь вибрации и не позволяют машине «ездить» по комнате.
                </p>
              </div>
            </section>
            <div className="page-container15">
              <h2 className="page-text34">
                <span>Основные пр��чины ��оломки:</span>
                <br></br>
              </h2>
            </div>
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Пружины подвески играют ключевую роль в работе стиральной машины — они удерживают бак в подвешенном состоянии и компенсируют вибрации при отжиме. Когда хотя бы одна пружина растянулась или сломалась, бак теряет устойчивость и начинает сильно раскачиваться. Из-за этого вы слышите громкий стук, глухие удары или даже металлический звон. Особенно ярко проблема проявляется на высоких оборотах, когда бак с бельём вращается с максимальной скоростью.

                  Почему это происходит? Со временем пружины изнашиваются — металл теряет упругость, появляются микротрещины, а иногда пружина может и вовсе лопнуть. В результате нагрузка распределяется неравномерно, бак смещается и начинает «бить» по корп��су. Это не только неприятный шум, но и риск повреждения других деталей — амортизаторов, противовесов, даже бака.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5-1" className="page-fiveproblem2-duplicate1">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Неравномерная или слишком большая загрузка – частая причина шума. Если вы кладёте в барабан большой комок вещей только с одной стороны, на отжиме машинка будет сильно болтаться. Распределяйте бельё равномерно по барабану. И не перегружайте стиралку по массе: если вещей много, попробуйте разделить стирку на две части или снизить обороты при отжиме. При перегрузке «скрипят» амортизаторы и барабан бь��тся о корпус из‑за избыточного веса.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5-2" className="page-fiveproblem2-duplicate2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  В барабан встроен подшипниковый узел – обычно два шарикоподшипника, закрытые резиновым уплотнителем (сальником). При длительной эксплуатации сальник протирается, внутрь попадает вода, смазка вымывается и подшипники ржавеют. Это вызывает люфт барабана �� неравномерное вращение. В итоге при отжиме машина может сильно шуметь и «прыгать», а иногда барабан клинит. Признаки износа подшипников – топот под машиной, подтеки ржавой воды и разболтанность бака при ручном движении. Починка ��ребует замены подшипников (и сальника) – в б��льшинстве моделей это комплексная работа, выполняемая в сервисе.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}

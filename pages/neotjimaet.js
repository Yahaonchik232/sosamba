          ...
          <div className="page-left-main-box">
              ...
              <ul className="page-ul list">
                <li className="page-li1 list-item">
                  ...
                  <a href="#1" className="page-link1 ge">
                    Что делать, если маш��на не отжимает
                  </a>
                </li>
            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  <span className="page-text19">1. Для начала проверьте сливной фильтр.</span>
                  <span> Он удерживает мелкие предметы — монеты, пуговицы, ворсинки, — и со временем забивается. Когда фильтр перекрыт, вода не проходит в насос, и программа отжима не запускается. Обычно фильтр находится внизу на передней панели: откройте лючок, выкрутите пробку и удалите скопившийся мус��р. После очистки попробуйте снова включить стирку.</span>
                  <br className="page-text21"></br>
                  <span className="page-text22">2. Если фильтр в порядке, обр��тите внимани�� на сливной шланг.</span>
                  <span> Он не должен быть перегнут или зажат мебелью. Изгибы мешают свободному стоку воды, и машина также отказывается переходить к отжиму. Осмотрите шланг по всей длине, расправьте петли и проверьте соединение с канализацией или сифоном. При необходимости очистите засор в сифоне или замените шланг.</span>
                  <br className="page-text24"></br>
                  <span className="page-text25">3. Ещё одна распространённая причина — неверные настройки.</span>
                  <span> Убедитесь, что вы не выбрали режим без отжима, например «Полоскание без отжима» или «Деликатная стирка». В некоторых программах скорость вращения барабана снижена или отжим отключён полностью, чтобы не повредить ткань. Если это так, просто перезапусти��е стирку с ��ужным режимом.</span>
                  <br className="page-text27"></br>
                  <span className="page-text28">4. Иногда проблема связана с загрузкой белья.</span>
                  <span> Если вещи сбились в комок, барабан не может сбалансироваться. Встроенный датчик дисбаланса блокирует разгон, чтобы машина не «скакала» по комнате. Перетряхните бельё в барабане, добавьте несколько мелких вещей или, наоборот, разделите большую партию на две стирки. Так бельё распределится равномерно, и отжим пройдёт без проблем.</span>
                  <br className="page-text30"></br>
                  <span className="page-text31">5. Если все эти меры не помогли, попробуйте перезагрузить электронику.</span>
                  <span> Выключите стиральную машину из розетки на 10–15 минут, затем включите снова и запустите короткий цикл. Иногда этого ��остаточно, чтобы сбросить сбой программы.</span>
                  <br className="page-text27"></br>
                  <span className="page-text28">6. Но если ��осле всех проверок отжим всё равно не запускается, скорее всего, речь идёт о неисправности насоса, датчиков или управляющего модуля.</span>
                  <br></br>
                </p>
              </div>
            </section>
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Если помпа сгорела или в ней сломана крыльчатка, машина не сможет слить воду и переход к отж��му невозможен. Признаки: вода остаётся в баке, машинка гудит во время слива или совсем молчит, и часто появляется ошибка слива на дисплее. Самостоятельный ремонт насоса обычно невозможен.
                </p>
              </div>
            </section>
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Приводной ремень передаёт вращение от двигателя к барабану. При о��лаблении или разрыве ремня барабан не сможет достичь нужных оборотов и бельё останется сырым. Обычно при этом двигатель пытается работать (маши���ка гудит), но барабан остаётся вялым или не вращается вовсе. Если ремень слетел, его можно перекинуть на место (д��я этого снимают заднюю стенку и ослабляют крепление мотора). Если же ремень изношен, потребуется его замена. Причиной разрыва может быть старение ремня или износ подшипников (при сильных люфтах на валу ремень перекидывается и рвётся.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5-1" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Полный отказ мотора (обрыв обмоток или короткое замыкание) – серьёзная проблема. Признак – при отжиме машина «зависает», двигатель гудит или совсем тих, а барабан не крутитс����. Могут выбиваться пробки электрической цепи. Ремонт двигателя – трудоёмкая операция, обычно его заменяют.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}

          ...
          <div className="page-left-main-box">
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Шланги, подводящие воду к машине и отводящие её в канализацию, сильно под��ержены механическим повреждениям. Например, если стиральную машину двигали или при транспортировке не убрали тр��нспортировочные крепления, шланг мог надорваться или отстегнуться. На старых машинках резиновый сливной шланг может рассохнуться и трескаться. В последнем случае воду видно под машиной во время слива – она капает снизу или из самого шланга.Совет: иногда проблему решает под��атягивание хомута на соединении шланга с насосом или патрубком. Если же шланг порван или прогрызен (иногда кошки любят погрызть упругую резину), лучше сразу заменить его новым – это недорогая мера, а эффект очень заметен. Аналогично проверьте шланг подачи воды: при ��ильных изгибах и перегибах он также может пропускать. Меняйте старые шланги примерно раз в пять–семь лет и при малейших признаках протечки меняйте крепления.
                </p>
              </div>
            </section>
            <section id="2-1" className="page-thirdproblem1-duplicate1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Если после набора воды заметили под стиралкой воду в районе лотка для порошка, причиной часто бывает его засор. Тогда часть воды «уползает» мимо и вытекает наружу. Иногда лоток просто трескается или расслаивается со временем – тогда вода тоже может уходить прямо через него.Совет: регулярно вынимайте и промывайте лоток для порошка и сам патруб��к подачи воды в бак. Если давление в водопроводе слишком сильное, воду может «выдавить» наружу – попробуйте немного прикрыть кран подачи. Не используйте слишком много моющего средства и только предназначенные для машин порошки – избыток пены тоже выгоняет влагу наружу. При появлении лужи на полу во время набора воды стоит отключить машинк��, собрать бельё и прочистить дозатор: обычно это быстро решает проблему.
                </p>
              </div>
            </section>
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Внутри машины по-прежнему течёт вода – и эт�� легко заметить по лужице под ней при заливе. К аварийным патрубкам относятся труба от лотка дозатора к баку и любые трубочки между баком, насосом и фильтром. Со временем соединения этих патрубков ослабевают от постоянной вибрации, а сами трубки могут забиваться засохшей грязью и мелкими крошками порошка. Засорённая или неплотно подсоединённая труба начинает пропускать в��ду на стыках, которая капает в поддон или сразу на пол.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  ...
                  <br />
                  <span className="tip-title">5. Обеспечьте ровную установку машины.</span> Стиральная машина должна стоять строго по уровню: если она «гуляет», вибрации ускоряют износ деталей. Регулируйте ножки так, чтобы машина была неподвижна при работе.
                  <br />
                  <span className="tip-title">6. Не перегружайте барабан.</span> Переполнение бельём нарушает баланс и увеличивает нагрузку на уплотнители и подшипники. Загружайте ровно столько, с��олько рекомендует производитель.
                  <br />
              ...
              <div className="page-container33">
                ...
                <div className="page-container35">
                  ...
                  <span className="page-text62">
                    Стиральная машина н�� крутит барабан
                  </span>
                </div>
              </div>
              <div className="page-container36">
                ...
                <div className="page-container38">
                  ...
                  <span className="page-text64">
                    Стира��ьная машина не нагревает воду
                  </span>
                </div>
              </div>
            </div>
            ...
            <section className="page-frame1299">
              ...
              <div className="page-frame12983">
                <span className="page-text75">
                  Почему стиралка воняет — 7 быстрых ��ричин и что сделать прямо
                  сейчас
                </span>

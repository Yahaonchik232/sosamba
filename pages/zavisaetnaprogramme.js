  ...
  return (
    <>
      <div className="page-container10">
        <Head>
          <title>Стиральная машина зависает на программе - причины и решения</title>
          <meta property="og:title" content="Стиральная машина зависает на программе - причины и решения" />
        </Head>
        <Header />
        <main className="page-main">
          <div className="page-left-main-box">
              ...
              <ul className="page-ul list">
                <li className="page-li1 list-item">
                  ...
                  <a href="#1" className="page-link1 ge">
                    Что делать, если стиральная машина зависает на программе
                  </a>
                </li>
            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  ...
                  <br />
                  Нажмите кнопку «Стоп» или «Пауза». В некоторых моделях ест�� отдельные режимы «Слив» или «Отжим» — выберите их и запустите на минимальных оборотах. Часто такой сброс по��огает завершить цикл и вернуть управление.
                  <br />
                  <strong>2. Если сброс не сработал — обесточьте машинку.</strong>
                  <br />
                  Вытащите вилку из розетки или отключите питание автоматом в щитке. Так вы полностью снимете напряжение и исключите дальнейшие сбои.
                  <br />
            ...
            <section id="2b" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  3. Проблемы с отводом воды (насос, патрубок, шланг)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Насос и сливной шланг отвечают за отвод воды из машины. Проверьте сливной шланг: при сильном перегибе или засоре вода плохо уходит. О��ключите шланг от канализации (или от задней части машины) и осмотрите его – при засоре рукав может «раздутся», быть забит грязью или мелкими предметами. Расправьте шланг, прочистите или замените его новым при необходимости.
                </p>
              </div>
            </section>
            ...
            <section id="2d" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  5. Проблемы с датчиком уровня воды (прессостат)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <section id="2e" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  ТЭН — это спираль, которая нагревает воду в баке. Если ТЭН не работает, вода не достигает нужной темпе��атуры, а блок управления бесконечно пытается её нагреть. Машина зависает: она набрала воду, но не греет её, пытаясь дотянуть до заданной температуры. Признаком неисправности ТЭНа является холодное стекло люка при выбранной горячей программе и возможная ошибка нагрева на дисплее.
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              <div className="page-container19 zagolovkiskorobkoy">
                <h3 className="zagolovki2">Удалено</h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
                  height="20"
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                <figure className="page-container24">
                  ...
                  />
                  <span className="page-text45">Щетк   дви��ате��я</span>
                </figure>
                <p className="page-text46 vicetext">
                  {' '}
                  1. Регулярно очищайте ��ильтр. Чистый фильтр предотвращает заторы из ворса и мелкого мусора.2. Не допускайте попадания мелких предметов. Проверяйте карманы одежды перед стиркой: монеты, заколки, носовые платки и т.п. часто попадают в барабан и могут попасть в патрубок.3. Следите за положением сливного шланга. Шланг не должен сильно перегибаться или пережиматься. Оптимальная высота его вывода – до 50 см от уровня пола. При эксплуатации следите, чтобы машинка стояла ровно и вибрировала минимально: излишняя вибра��ия мож��т пе��етёреть провода или ослабить патрубки.4. Не за��ывайте проверять ка��ализацию. Убедитесь, что в стояке или сифоне нет засора. Если вода из раковины уходит медленно, жидкость из стиральной может застаиваться. Время от времени очищайте сантехнику в доме, чтобы слив машины работал беспрепятственно.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  ...
                  После сборки провер��те слив – при отсутствии засора вода
